...
def set_results_db(cursor: sqlite3.Cursor):
    table = '''CREATE TABLE IF NOT EXISTS RAPID_JOB_DATA(JOB_ID TEXT PRIMARY KEY, JOB_SITE TEXT, JOB_URL TEXT, JOB_TITLE 
            TEXT, JOB_COMPANY TEXT, JOB_LOCATION TEXT, JOB_TYPE TEXT, JOB_DATE_POSTED TEXT, JOB_SALARY_INTERVAL TEXT,JOB
            _SALARY_MIN INT, JOB_SALARY_MAX INT, JOB_IS_REMOTE TEXT, JOB_EMAILS TEXT, JOB_DESCRIPTION TEXT);'''
    cursor.execute(table)
